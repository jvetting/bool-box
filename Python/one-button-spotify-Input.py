...
# To use:
# When running program, include playlist uri as commandline argument. Otherwise, program will run hardcoded playlist
...
def take_input():
    user_input = input('BoolBox - ').strip()
    # doing something with the input
    print('BoolBox - ', user_input)
